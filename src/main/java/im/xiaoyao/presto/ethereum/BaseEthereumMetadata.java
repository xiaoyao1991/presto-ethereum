...
public abstract class BaseEthereumMetadata implements ConnectorMetadata {
    ...
    public EthereumTableHandle getTableHandle(ConnectorSession session, SchemaTableName schemaTableName) {
        if (Arrays.stream(EthereumTable.values())
        ...
        return new EthereumTableHandle(DEFAULT_SCHEMA, schemaTableName.getTableName());
    }
    ...
    public List<SchemaTableName> listTables(ConnectorSession session, Optional<String> schemaName) {
        return Arrays.stream(EthereumTable.values())
