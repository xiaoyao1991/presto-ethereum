...
public enum EthereumERC20Token {
    ...
    public static final Map<String, EthereumERC20Token> lookup = Arrays.stream(EthereumERC20Token.values())
            .collect(Collectors.toMap(EthereumERC20Token::getTokenContractAddr, ethereumERC20Token -> ethereumERC20Token));

    @Getter private final String tokenContractAddr;
    EthereumERC20Token(String tokenContractAddr) {
